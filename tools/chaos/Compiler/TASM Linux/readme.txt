This is the LINUX shareware distribution disk for 
       TASM - The Telemark Assembler 

The files on the disk include: 

tasm              - tasm Assembler, executable
...
testtabs.sh       - Bash script to execute tasm for each test case.
moto.h            - Useful directive definitions for Motorola compatibility
tasmdoc.htm       - TASM User's Manual Archive (zoo format)
...
To extract tasm from the archive file:
...
$40.00 check or money order to: 
        ...
        Issaquah,  WA  98027
        andersontn@acm.org
        Thomas_N_Anderson@compuserve.com
